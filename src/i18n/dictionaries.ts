...
const dictionaries = {
  ...
  fr: () => import("./locales/fr.json").then((module) => module.default),
    ...
    et: () => import("./locales/et.json").then((m) => m.default),
    sl: () => import("./locales/sl.json").then((m) => m.default),
    hy: () => import("./locales/hy.json").then((m) => m.default),
    ...
    af: () => import("./locales/af.json").then((m) => m.default),
    hr: () => import("./locales/hr.json").then((m) => m.default),
    hu: () => import("./locales/hu.json").then((m) => m.default),
    bs: () => import("./locales/bs.json").then((m) => m.default),
