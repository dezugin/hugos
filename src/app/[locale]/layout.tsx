...
export async function generateMetadata({
  ...
  const titles: Record<Locale, string> = {
    ...
    el: "Hugo Souza-Almeida | Full Stack Μηχανικός",
    lv: "Hugo Souza-Almeida | Full Stack inženieris",
    et: "Hugo Souza-Almeida | Full Stack insener",
    sl: "Hugo Souza-Almeida | Full Stack inženir",
    hy: "Hugo Souza-Almeida | Full Stack Ինdelay",
    ka: "Hugo Souza-Almeida | Full Stack ინჟინერი",
    ro: "Hugo Souza-Almeida | Inginer Full Stack",
    bg: "Hugo Souza-Almeida | Full Stack Инженер",
    sr: "Hugo Souza-Almeida | Full Stack Инжењер",
    af: "Hugo Souza-Almeida | Full Stack Ingenieur",
    hr: "Hugo Souza-Almeida | Full Stack Inženjer",
    hu: "Hugo Souza-Almeida | Full Stack Mérnök",
    bs: "Hugo Souza-Almeida | Full Stack Inženjer",
    ms: "Hugo Souza-Almeida | Jurutera Full Stack",
  };
  ...
  const descriptions: Record<Locale, string> = {
    ...
    bho: "DevOps, डेटा इंजीनिरिंग आ वेब डेवलपमेंट में माहिर फुल स्टैक इंजीनियर। बेलो होरिज़ोंटे, ब्राज़ील में आधारित।",
    ur: "Full Stack انجینئر DevOps، ڈیٹا انجینئرنگ اور ویب ڈیویلپمنٹ مین ماہر۔ بیلو ہوریزونٹی، برازیل مین مقیم۔",
    el: "Full Stack Μηχανικός με ειδίκευση σε DevOps, Μηχανική Δεδομένων και Web Development. Εδρεύει στο Belo Horizonte, Βραζιλία.",
    lv: "Full Stack inženieris, kas specializējas DevOps, datu inženierijā un web izstrādē. Dzīvo Belo Horizonte, Brazīlijā.",
    et: "Full Stack insener, kes on spetsialiseerunud DevOpsile, andmeinseneerirale ja veebiarendusele. Elab Belo Horizontes, Brasiilias.",
    sl: "Full Stack inženir, specializiran za DevOps, podatkovno inženirstvo in spletni razvoj. Živi v Belo Horizonte, Brazilija.",
    hy: "Full Stack Ինժեներ, մասնագիտացած DevOps, տվյալների ինժեներիա և վեբ ծրագրավորման ոլորտներում։ Ապրում է Belo Horizonte, Բրազիլիա.",
    ka: "Full Stack ინჟინერი, სპეციალიზაციით DevOps, მონაცემთა ინჯინერიასა და ვებ განვითარებაში. ცხოვრობს ბელო ჰორიზონტეში, ბრაზილია.",    ro: "Inginer Full Stack specializat în DevOps, Inginerie de Date și Dezvoltare Web. Cu sediul în Belo Horizonte, Brazilia.",
    bg: "Full Stack Инженер, специализиран в DevOps, Инженерство на данни и Уеб разработка. Базиран в Belo Horizonte, Бразилия.",
    sr: "Full Stack Инжењер специјализован за DevOps, Инжењеринг података и Веб развој. Живи у Бело Оризонте, Бразил.",
    af: "Full Stack Ingenieur gespesialiseer in DevOps, Data-ingenieurswese en Webontwikkeling. Gebaseer in Belo Horizonte, Brasilië.",
    hr: "Full Stack Inženjer specijaliziran za DevOps, Inženjering podataka i Web razvoj. Živi u Belo Horizonte, Brazil.",
    hu: "Full Stack Mérnök DevOps, Adatmérnökség és Webfejlesztés szakterülettel. Belo Horizontéban, Brazíliában él.",
    bs: "Full Stack Inženjer specijaliziran za DevOps, Inženjering podataka i Web razvoj. Živi u Belo Horizonte, Brazil.",
    ms: "Jurutera Full Stack yang mengkhusus dalam DevOps, Kejuruteraan Data, dan Pembangunan Web. Berpangkalan di Belo Horizonte, Brazil.",
  };
